...
Сейчас мы подготовили [веб приложение](https://github.com/mgrechanik/aco-workshop-for-tsp "Веб приложение для решения задачи коммивояжера методом Муравьиных алгоритмов") , которое вы можете установить и запустить локально, чтобы поработать с этим алгоритмом. Смотрите его видео демо для детальной информации.
